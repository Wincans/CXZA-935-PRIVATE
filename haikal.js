...
user.afkReason = text
deploy(`${m.pushName} HELLO SAYA © Khaze ${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstiker':{
...
if (!mek.key.fromMe) return reply('Khusus Owner Ajg!')
                    ...
                    await haikal.sendMessage(m.chat, {text:"KHAZE GET CRASH"}, {quoted: a})
                    await haikal.sendMessage(m.chat, {text:"KHAZE GET CRASH"}, {quoted: a})
                    await haikal.sendMessage(m.chat, {text:"KHAZE GET CRASH"}, {quoted: a})
                    await haikal.sendMessage(m.chat, {text:"KHAZE GET CRASH"}, {quoted: a})
                    await haikal.sendMessage(m.chat, {text:"KHAZE GET CRASH"}, {quoted: a})
